...
public class HandleException {
    ...
    public ResponseEntity<Response> handleValidationException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new Response(LocalTime.now().toString(), HttpStatus.BAD_REQUEST.value(), request.getRequestURI(), HttpStatus.BAD_REQUEST, "Erreur de validation", EMPTY, Map.of("errors", errors)));
    }
