...
public class PatientQuery {
    ...
    public static final String INSERT_PATIENT_QUERY = """
        INSERT INTO patients (
            patient_uuid, user_uuid, date_of_birth, gender, blood_type,
            height_cm, weight_kg, allergies, chronic_conditions, current_medications,
            emergency_contact_name, emergency_contact_phone, emergency_contact_relationship,
            medical_record_number, insurance_number, insurance_provider, active
        ) VALUES (
            :patientUuid, :userUuid, :dateOfBirth, :gender, :bloodType,
            :heightCm, :weightKg, :allergies, :chronicConditions, :currentMedications,
            :emergencyContactName, :emergencyContactPhone, :emergencyContactRelationship,
            :medicalRecordNumber, :insuranceNumber, :insuranceProvider, :active
        )
        RETURNING *
        """;
    ...
    public static final String SELECT_PATIENTS_BY_BLOOD_TYPE_QUERY = """
        SELECT * FROM patients 
        WHERE blood_type = :bloodType AND active = true
        ORDER BY created_at DESC
        """;
