 ...
 * Le JWT contient un claim personnalisé appelé authorities
...
public class JwtConverter implements Converter<Jwt, JwtAuthenticationToken> {
     ...
     * lorsqu'une requête HTTP arrive avec un header : Authorization: Bearer &lt;jwt&gt;
     * Lire le claim <b>authorities</b> depuis le JWT</li>
     * Convertir la chaîne "ROLE_USER,ROLE_ADMIN" en objets GrantedAuthority
     * Créer un {@link JwtAuthenticationToken}</li>
     *
